...
-- profiles: read/update your own; staff can read their cohort members
...
-- cohorts: members/owners can read; teachers/admins can create & manage their own
...
-- cohort_members: see your own membership; staff see the roster (join via RPC)
...
-- learning data: full control of your own rows; staff may read members' rows
...
-- events: append your own; read your own
