...
(function () {
  ...
  function steps() {
    return [
      ...
      { page: "home", center: true, t: "Missions can READ to you 🔊",
        body: "Here's a secret power: at the bottom of every mission there's a button that says “Turn on audio learning.” Tap it once and I'll read every screen out loud to you — perfect if you'd rather listen while you learn. Tap it again any time to turn it off." },
      { page: "home", center: true, t: "Make your own study music 🎵",
        body: "Right next to it is the 🎵 button — that's Study Beats! A computer composes chill background music LIVE while you learn. Open it, press Play, and tap “Remix the beat!” until it sounds just right — new drums, new melodies, your vibe. It's yours to tune." },
